...
from .views import home, about, contact, CategoryView, ProductDetail, AddToCart1, ShowCart, PlusCart, MinusCart, RemoveCart, Checkout, OrderView
...
urlpatterns = [
    ...
    ## Cart
    path('add-to-cart/', AddToCart1.as_view(), name='add-to-cart'),
